...
import com.arnold.weatherapp.presenters.MenuPresenter
import com.arnold.weatherapp.view.MenuView
import com.arnold.weatherapp.view.adapters.CityListAdapter
import com.arnold.weatherapp.view.createObservable
...
class MenuActivity : MvpAppCompatActivity(), MenuView {
    ...
    override fun fillFavouriteList(data: List<GeoCodeModel>) {
        (favourites.adapter as CityListAdapter).updateData(data)
    }
