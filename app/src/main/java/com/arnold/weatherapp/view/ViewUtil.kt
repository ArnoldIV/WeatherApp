...
fun String.provideImage() = when (this) {
    "01n", "01d" -> R.mipmap.sun_xhdpi
    "02n", "02d" -> R.mipmap.clear_cloud_xhdpi
    "03n", "03d" -> R.mipmap.clear_cloud_xhdpi
    "04n", "04d" -> R.mipmap.sun_xhdpi
    "09n", "09d" -> R.mipmap.raining_cloud_xhdpi
    "10n", "10d" -> R.mipmap.sun_xhdpi
    "11n", "11d" -> R.mipmap.storming_cloud_xhdpi
    "13n", "13d" -> R.mipmap.snow_cloud_xhdpi
    "50n", "50d" -> R.mipmap.sun_xhdpi
    else ->R.drawable.ic_error
}
