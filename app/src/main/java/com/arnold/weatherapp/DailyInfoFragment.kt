...
class DailyInfoFragment : DailyBaseFragment<DailyWeatherModel>() {
    ...
    override fun updateView() {
        ...
        mData?.apply {
            ...
            day_pressure.text = viewContext.getString(settingPressure.measureUnitStringRes,settingPressure.getValue(pressure.toDouble()))
            val settingWindSpeed = SettingsHolder.windSpeed
            day_wind_speed.text = viewContext.getString(settingWindSpeed.measureUnitStringRes,settingWindSpeed.getValue(wind_speed))
